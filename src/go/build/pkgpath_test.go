...
func TestFormatImportPath(t *testing.T) {
	...
	testCases := []*_Case{
		...
		&_Case{19, `.`, `noroot1/testdata/local1`, nil, &_Want{OriginImportPath: `.`, ImporterDir: `v:\noroot1\testdata\local1`, FmtImportPath: `.`, Dir: `v:\noroot1\testdata\local1`, Root: ``, ConflictDir: ``, Type: PackageStandAlone, Style: ImportStyleSelf, Formated: true}},
		&_Case{20, `.`, `localroot1/src/testdata/local1`, nil, &_Want{OriginImportPath: `.`, ImporterDir: `v:\localroot1\src\testdata\local1`, FmtImportPath: `.`, Dir: `v:\localroot1\src\testdata\local1`, Root: ``, ConflictDir: ``, Type: PackageStandAlone, Style: ImportStyleSelf, Formated: true}},
